...
window.aStoryAboutDogs = [
  ...
  {level: 2, text: "I hope he does, at least."}
  {level: 2, text: "Sometimes he seems a little sad.", next: true}
  ...
  {level: 2, text: "Has he? We've tried, at least."}
  ...
  {level: 11, text: "James needs to be more careful crossing that street.", next: true}
  {level: 10, text: "I keep thinking about what death must feel like."}
  {level: 10, text: "A wave struggling to keep hold on the beach, only to slip away."}
  {level: 10, text: "It seems like it would move front to back."}
  {level: 10, text: "Would trauma like a gunshot to the temple feel the same, only faster? Perhaps."}
  ...
  {level: 13, text: "The loss makes the love all the brighter."}
  {level: 13, text: "Emotional pain hurts the most, but emotional pleasure is the highest imaginable.", next: true}
